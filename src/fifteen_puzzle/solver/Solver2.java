...
import fifteen_puzzle.state.State2;
...
public final class Solver2 extends Solver<State2> {

    // Constructor
    public Solver2(String filePath) {
        super(filePath);
    }
    ...
    protected void setInitialState(int[][] initialBoard) {
        initialState = new State2(initialBoard);
    }
    ...
    public void solve() {
        ...
        while (true) {
            ...
            State2 currState = openList.poll();
            if (currState == null) {
                solved = true;
                foundSolution = false;
                return;
            ...
            // Generate neighbours
            ArrayList<State2> neighbours = currState.getNeighbours();
            for (State2 neighbour: neighbours) {
