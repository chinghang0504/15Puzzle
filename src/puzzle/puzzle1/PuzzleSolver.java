...
public class PuzzleSolver implements PuzzleResult, Runnable {
    ...
    private class PuzzleState {
        ...
        public boolean equals(Object o) {
            ...
            return stepCount == that.stepCount && manhattanDistance == that.manhattanDistance && Arrays.deepEquals(board, that.board);
        }

        // Hash code
        @Override
        public int hashCode() {
            int result = Objects.hash(stepCount, manhattanDistance);
